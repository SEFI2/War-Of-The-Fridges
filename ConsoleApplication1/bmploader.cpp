...
inline void LoadBMPFile(uchar4 **dst, int *width, int *height, const char *name)
{
	BMPHeader hdr;
...
inline void SaveBMPFile(uchar4 *dst, int width, int height, const char *outputname, const char *inputname) {
	BMPHeader hdr;
	BMPInfoHeader infoHdr;
	int x, y;
